...
void callbackWindow(reflect::Window &win) { win.close(); }
} // namespace LIBC_NAMESPACE
...
protected:
  ...
  void SetUp() override {
    ...
    window = new reflect::Window(instance, "win");
  }
...
TEST_F(WindowTestFixture, WindowNotificationTest) {
  reflect::Notification notification("Test title", "Lorem ipsum dolor sit amet, consectetur adipiscing elit.");
